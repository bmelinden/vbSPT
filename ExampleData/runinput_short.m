...
outputfile='./Results/testresult_VB3_HMM_short'; % NOTE: This file will be overwritten !!!
...
trjLmin=7;  % trajectories with fewer than trjLmin positions are excluded from 
            % the analysis. Default=2 (recommended; this variable is
            % included for testing purposes).

% Convergence and things to compute:
runs=3;    % number of attempts at each model size (make a multiple of 
            % number of cores when running in parallel)
maxHidden=6;    % maximum number of hidden states to consider. 
...
bootstrapNum=10; % number of bootstrap resamplings
