...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                 %
%       VBviterbi_log for VB HMM analysis         %
% =============================================== %
%                                                 %
...
/*
 ...
 lnQ=log(Q), and lnqst is the emission log likelihood. Constructed for
 use with ensemble learning of Hidden Markov models, M.L. 2011-12-20

 compilation:
 mex('VBviterbi.c',['-' computer('arch')],'-O')
 
 M.L. 2011-12-23 : version that avoids underflow errors by working
 with the log of the transition matrix and emission likelihood.
 */
