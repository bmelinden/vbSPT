function est=VB4_parameterEstimates(M)
% est=VB4_parameterEstimates(M)
...
% alone, same as done by VB4_VBEMiterator

%% copyright notice
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% VB4_parameterEstimates, generate some estimates based on a M-field
% =========================================================================
% 
