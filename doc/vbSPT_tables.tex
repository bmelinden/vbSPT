...
%\texttt{prior\_piStrength} & int & Prior strength for the initial
%state probability (assumed uniform), given in pseudocounts and should
%be set low. Recommended default value: 5.\\ [0.5ex] \hline
...
\end{longtable}
\ML{removed: \texttt{prior\_piStrength} and
  \texttt{prior\_tDstrength}.}
