...
diffusion constant. Default: 'mean\_strength'. \\ [0.5 ex] \hline
...
initial state prior. Alternatives: 'flat' (default), and
'const\_strength'. \\ [0.5 ex] \hline

'flat': no parameteres needed. && A flat Dirichlet prior;
$\tilde w_j^{(\vec{\pi})}=1$. \\ [0.5 ex] \hline

const\_strength': \texttt{prior\_piStrength} & int & Prior strength $\tilde
